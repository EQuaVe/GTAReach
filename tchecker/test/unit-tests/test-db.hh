...
TEST_CASE("construction of upper bounds", "[db]")
{
  ...
  SECTION("provided upper bounds")
  {
    ...
    REQUIRE(VAL(tchecker::dbm::LE_INFINITY) == max_int_used);
  }
  ...
  SECTION("non representable upper bounds")
  {
    ...
    REQUIRE_THROWS_AS(DB(tchecker::dbm::LE, max_int_used + 1), std::invalid_argument);
    REQUIRE_THROWS_AS(DB(tchecker::dbm::LT, min_int_used - 1), std::invalid_argument);
    REQUIRE_THROWS_AS(DB(tchecker::dbm::LT, min_int_used), std::invalid_argument);
    REQUIRE_THROWS_AS(DB(tchecker::dbm::LE, min_int_used - 1), std::invalid_argument);
    REQUIRE_THROWS_AS(DB(tchecker::dbm::LE, min_int_used), std::invalid_argument);
    
    REQUIRE_NOTHROW(DB(tchecker::dbm::LT, max_int_used));
    REQUIRE_NOTHROW(DB(tchecker::dbm::LE, max_int_used));
    REQUIRE_NOTHROW(DB(tchecker::dbm::LT, max_int_used - 1));
    REQUIRE_NOTHROW(DB(tchecker::dbm::LT, min_int_used + 1));
    REQUIRE_NOTHROW(DB(tchecker::dbm::LE, min_int_used + 1));
...
TEST_CASE("comparators <,<=,>=,>", "[db]")
{
  ...
  SECTION("greater-than comparator > w.r.t. <infinity and <=infinity")
  {
    REQUIRE_FALSE(tchecker::dbm::LT_INFINITY > tchecker::dbm::LT_INFINITY);
    ...
    REQUIRE(tchecker::dbm::LT_INFINITY > le_m1);
    REQUIRE(tchecker::dbm::LT_INFINITY > lt_m5);
    REQUIRE(tchecker::dbm::LE_INFINITY > le_1);
    REQUIRE(tchecker::dbm::LE_INFINITY > lt_1);
    REQUIRE(tchecker::dbm::LE_INFINITY > le_m1);
    REQUIRE(tchecker::dbm::LE_INFINITY > lt_m5);
    ...
    REQUIRE_FALSE(le_m1 > tchecker::dbm::LT_INFINITY);
    REQUIRE_FALSE(lt_m5 > tchecker::dbm::LT_INFINITY);
    REQUIRE_FALSE(le_1 > tchecker::dbm::LE_INFINITY);
    REQUIRE_FALSE(lt_1 > tchecker::dbm::LE_INFINITY);
    REQUIRE_FALSE(le_m1 > tchecker::dbm::LE_INFINITY);
    REQUIRE_FALSE(lt_m5 > tchecker::dbm::LE_INFINITY);


    REQUIRE(tchecker::dbm::LT_INFINITY > tchecker::dbm::LE_ZERO);
    REQUIRE(tchecker::dbm::LE_INFINITY > tchecker::dbm::LE_ZERO);
    
    REQUIRE_FALSE(tchecker::dbm::LE_ZERO > tchecker::dbm::LT_INFINITY);
    REQUIRE_FALSE(tchecker::dbm::LE_ZERO > tchecker::dbm::LE_INFINITY);
...
TEST_CASE("sum", "[db]")
{
  ...
  tchecker::dbm::db_t le_big = DB(tchecker::dbm::LE, max_int_used);
  tchecker::dbm::db_t le_small = DB(tchecker::dbm::LE, min_int_used+1);
