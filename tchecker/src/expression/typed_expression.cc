...
void typed_expression_t::visit(tchecker::typed_expression_visitor_t & v) const { /*std::cout << "ani:38 from typed expression visitor " << std::endl;*/ return this->do_visit(v); }
...
void typed_int_expression_t::do_visit(typed_expression_visitor_t & v) const { v.visit(*this); }
...
typed_var_expression_t::typed_var_expression_t(enum tchecker::expression_type_t type, std::string const & name,
    ...
    : tchecker::make_typed_lvalue_expression_t<tchecker::var_expression_t>(type, name), _id(id), _size(size)
{
  if (size < 1)
...
void typed_var_expression_t::do_visit(tchecker::typed_expression_visitor_t & v) const { v.visit(*this); }
...
void typed_bounded_var_expression_t::do_visit(tchecker::typed_expression_visitor_t & v) const { v.visit(*this); }
...
void typed_array_expression_t::do_visit(tchecker::typed_expression_visitor_t & v) const { v.visit(*this); }
...
void typed_par_expression_t::do_visit(tchecker::typed_expression_visitor_t & v) const { v.visit(*this); }
...
void typed_binary_expression_t::do_visit(tchecker::typed_expression_visitor_t & v) const { v.visit(*this); }
...
void typed_unary_expression_t::do_visit(tchecker::typed_expression_visitor_t & v) const { v.visit(*this); }
...
typed_ite_expression_t::typed_ite_expression_t(tchecker::expression_type_t type, tchecker::typed_expression_t * cond,
...
void typed_ite_expression_t::do_visit(tchecker::typed_expression_visitor_t & v) const { v.visit(*this); }
