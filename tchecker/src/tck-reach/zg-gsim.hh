...
#ifndef TCHECKER_ZG_GSIM_ALGORITHM_HH
#define TCHECKER_ZG_GSIM_ALGORITHM_HH
...
public:
  ...
  same discrete part
  */
  std::size_t operator()(tchecker::tck_reach::zg_gsim::node_t const & n) const;
};
...
public:
  ...
  */
  node_le_t(tchecker::amap::a_map_t const & amap);
  ...
  */
  node_le_t(tchecker::tck_reach::zg_gsim::node_le_t const & node_le);

  /*!
  \brief Move constructor
  */
  node_le_t(tchecker::tck_reach::zg_gsim::node_le_t && node_le);
  ...
  */
  tchecker::tck_reach::zg_gsim::node_le_t & operator=(tchecker::tck_reach::zg_gsim::node_le_t const & node_le) = delete;

  /*!
   \brief Move-assignment operator
  */
  tchecker::tck_reach::zg_gsim::node_le_t & operator=(tchecker::tck_reach::zg_gsim::node_le_t && node_le) = delete;
  ...
  */
  bool operator()(tchecker::tck_reach::zg_gsim::node_t const & n1, tchecker::tck_reach::zg_gsim::node_t const & n2) const;

private:
  tchecker::amap::a_map_t const & _amap; /*!< an a-map */
...
class graph_t : public tchecker::graph::subsumption::graph_t<
                    tchecker::tck_reach::zg_gsim::node_t, tchecker::tck_reach::zg_gsim::edge_t,
                    tchecker::tck_reach::zg_gsim::node_hash_t, tchecker::tck_reach::zg_gsim::node_le_t> {
public:
  /*!
   \brief Constructor
   \param zg : zone graph
  ...
  */
  ...
  using tchecker::graph::subsumption::graph_t<
      tchecker::tck_reach::zg_gsim::node_t, tchecker::tck_reach::zg_gsim::edge_t,
      tchecker::tck_reach::zg_gsim::node_hash_t, tchecker::tck_reach::zg_gsim::node_le_t>::attributes;
...
protected:
  ...
  */
  virtual void attributes(tchecker::tck_reach::zg_gsim::node_t const & n, std::map<std::string, std::string> & m) const;
  ...
  */
  virtual void attributes(tchecker::tck_reach::zg_gsim::edge_t const & e, std::map<std::string, std::string> & m) const;
...
*/
class algorithm_t
    : public tchecker::algorithms::covreach::algorithm_t<tchecker::zg::zg_t, tchecker::tck_reach::zg_gsim::graph_t> {
public:
  using tchecker::algorithms::covreach::algorithm_t<tchecker::zg::zg_t, tchecker::tck_reach::zg_gsim::graph_t>::algorithm_t;
};
...
#endif // TCHECKER_ZG_GSIM_ALGORITHM_HH
