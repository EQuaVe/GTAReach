...
public:
  ...
  using tchecker::syncprod::system_t::prophecy_clock_events;
  using tchecker::syncprod::system_t::normal_clock_ids;
  std::vector <int> used_history_clocks_ids;
  std::vector <std::string> used_history_clock_events;
  std::vector <int> un_used_history_clocks_ids;
  std::vector <int> used_prophecy_clocks_ids;
  std::vector <std::string> used_prophecy_clock_events;
  std::vector <int> un_used_prophecy_clocks_ids;
  std::vector <std::tuple<int,int>> events_prop_ids;
  std::vector <std::tuple<int,int>> events_hist_ids;
