...
public:
  /*!
   ...
   \note all location ID in [0..loc_nb) are assumed to be valid
   */
  eca_a_map_t(tchecker::loc_id_t loc_nb);
  ...
  /*!
   ...
   \brief this is a copy of m
   */
  eca_a_map_t(tchecker::eca_amap_gen2::eca_a_map_t const & m);
  ...
  /*!
   ...
   \post m has been moved to this
   */
  eca_a_map_t(tchecker::eca_amap_gen2::eca_a_map_t && m);
  ...
  /*!
   ...
   \post this is a copy of m
   */
  tchecker::eca_amap_gen2::eca_a_map_t & operator=(tchecker::eca_amap_gen2::eca_a_map_t const & m);
  ...
  /*!
   ...
   \post m has been moved to this
   */
  tchecker::eca_amap_gen2::eca_a_map_t & operator=(tchecker::eca_amap_gen2::eca_a_map_t && m);
