...
edge:P${pid}:q0:q1:TT{{provided: trt${pid}>=${TTRT} ; do: trt${pid},xB${pid};}}
edge:P${pid}:q0:q2:TT{{provided: trt${pid}<${TTRT} ; do: trt${pid},xB${pid};}}
edge:P${pid}:q1:q4:RT{{provided: trt${pid}==${SA};}}
edge:P${pid}:q2:q3:tau{{provided: trt${pid}==${SA};}}
edge:P${pid}:q3:q4:RT{{}}
edge:P${pid}:q4:q5:TT{{provided: trt${pid}>=${TTRT} ; do: trt${pid},xA${pid};}}
edge:P${pid}:q4:q6:TT{{provided: trt${pid}<${TTRT} ; do: trt${pid},xA${pid};}}
...
edge:R:r${pid}:q$(($pid+1)):RT${pid}{{provided:;do: t;}}"
done

echo "edge:R:q${N}:r${N}:TT${N}{{provided: t==${TD};}}
edge:R:r${N}:q1:RT${N}{{provided:;do: t;}}
"
