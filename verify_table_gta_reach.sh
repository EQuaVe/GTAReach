...
./run.sh gta_gsim ./examples_from_the_paper/table_verify_gta/toyECA_10000_4.txt
echo ""

echo "Running ToyECA(5000,6)"
./run.sh gta_gsim ./examples_from_the_paper/table_verify_gta/toyECA_5000_6.txt
echo ""

echo "Running ToyECA(1000,100)"
./run.sh gta_gsim ./examples_from_the_paper/table_verify_gta/toyECA_1000_100.txt
echo ""

echo "Running ToyECA(50000,120)"
./run.sh gta_gsim ./examples_from_the_paper/table_verify_gta/toyECA_50000_120.txt
echo ""
