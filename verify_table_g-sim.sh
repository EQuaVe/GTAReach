...
./run.sh gsim ./examples_from_the_paper/table_verify_gsim/Dining_Phi_6.txt | grep -Ee "(TIME)|(STORED)|(VISITED)"
echo ""

echo "Running FDDI (10)"
./run.sh gsim ./examples_from_the_paper/table_verify_gsim/FDDI_10.txt | grep -Ee "(TIME)|(STORED)|(VISITED)"
echo ""

echo "Running Fischer (10)"
./run.sh gsim ./examples_from_the_paper/table_verify_gsim/Fischer_10.txt | grep -Ee "(TIME)|(STORED)|(VISITED)"
echo ""
...
./run.sh gsim ./examples_from_the_paper/table_verify_gsim/toyECA_10000_4.txt | grep -Ee "(TIME)|(STORED)|(VISITED)"
echo ""
...
./run.sh gsim ./examples_from_the_paper/table_verify_gsim/toyECA_5000_6.txt | grep -Ee "(TIME)|(STORED)|(VISITED)"
echo ""
